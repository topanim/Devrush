...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/cmpcountrycodepickerdemo.cmpcountrycodepicker.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/cmpcountrycodepickerdemo.cmpcountrycodepicker.generated.resources/" +
      path)
